...
<div class="swipe">
	<div class="swipe-menu">
		<ul class="links">
			...
			<li><a class="<?php if (isset($this->request->get['route']) && $this->request->get['route']=="account/wishlist") {echo "active";} ?>" href="<?php echo $wishlist; ?>" id="wishlist-total1"><i class="fa fa-star"></i><?php echo $text_wishlist; ?></a></li>
...
<div class="container">
<?php if (!empty($error)) { ?>
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/theme336/image/close-1.png" alt="" class="close" /></div>
<?php } ?>
