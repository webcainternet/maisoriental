		...
		<ul class="row">
		  ...
		  <?php 
			...
			<li class="<?php echo $a. $last_line ;?> col-sm-<?php echo $spanLine ;?>">
				...
				<div class="image2">
					<?php if ($product['thumb']) { ?><a title="<?php echo $product['name']; ?>" href="<?php echo $product['href']; ?>"><img id="img_<?php echo $product['product_id']; ?>" src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a><?php } ?>
					...
					<div  class="quick-view<?php echo $i;?> preview">
						<div class="wrapper marg row">
							...
							<div class="right col-sm-8">
								...
								<div class="clear"></div>
								<div class="rating">
									<img height="18" src="catalog/view/theme/theme336/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
								</div>
							</div>
						</div>
				...
				<a href="<?php echo $product['href']; ?>"   rel="colorbox" class="colorbox<?php echo $i;?> quick-view-button"><i class=" fa fa-search-plus "></i></a>
				<?php } ?>
				<div class="inner">
					...
					<div class="f-left">						
						...
						<div class="description"><?php echo mb_substr($product['description1'],0,92,'UTF-8').'...';?></div>
						<?php } ?>	
